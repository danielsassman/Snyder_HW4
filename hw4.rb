...
#Saves intial returns in hash table so once it computes the fib once it can use 
...
def test_zipwith_1
		...
		zipwith(add, [1,2,3,4], [10,10,10,10])
    end

def test_file_report_4
	  make_file("1\n2\n3\n4\n",$TEMP_FILE)
	  rep = file_report($TEMP_FILE)
	 # check_report(rep,2.5,2.5,[1,2,3,4])
    end
